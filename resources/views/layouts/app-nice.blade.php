...
<head>
    ...
    <title>Rizki Murtadha | Hasnur</title>
    <meta content="" name="description">
    <meta content="" name="keywords">

    <!-- Favicons -->
    <link href="{{ asset('nice/assets/img/icon.png') }}" rel="icon">
    <link href="{{ asset('nice') }}/assets/img/icon.png" rel="apple-touch-icon">
...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="{{ route('home') }}" class="logo d-flex align-items-center">
                <img src="{{ asset('nice') }}/assets/img/icons.png" alt="">
                <span class="d-none d-lg-block">RizkiMurtadha</span>
            </a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
                        ...
                        <li class="message-item">
                            <a href="#">
                                <img src="{{ asset('nice') }}/assets/img/messages-1.jpg" alt=""
                        ...
                        <li class="message-item">
                            <a href="#">
                                <img src="{{ asset('nice') }}/assets/img/messages-2.jpg" alt=""
                                    class="rounded-circle">
                                <div>
                                    <h4>Anna Nelson</h4>
                                    <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                        ...
                        <li class="message-item">
                            <a href="#">
                                <img src="{{ asset('nice') }}/assets/img/messages-3.jpg" alt=""
                                    class="rounded-circle">
                                <div>
                                    <h4>David Muldon</h4>
                                    <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request()->routeIs('project*') ? '' : 'collapsed' }}"
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request()->routeIs('task') ? '' : 'collapsed' }}" href="{{ route('task') }}">
            ...
            {{-- <li class="nav-item">
                <a class="nav-link {{ Request()->routeIs('video*') ? '' : 'collapsed' }}"
                    href="{{ route('video') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request()->routeIs('article') ? '' : 'collapsed' }}"
                    href="{{ route('article') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request()->routeIs('post*') ? '' : 'collapsed' }}"
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request()->routeIs('activity') ? '' : 'collapsed' }}"
                    href="{{ route('activity') }}">
    ...
    <footer id="footer" class="footer">
        ...
        <div class="credits">
            ...
            Designed by <a href="#">Muhammad Rizki Murtadha</a>
        </div>
    </footer><!-- Akhir Footer -->
